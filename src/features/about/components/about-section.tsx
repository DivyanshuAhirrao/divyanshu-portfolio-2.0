  ...
  return (
    <section id="about" className="border-b border-line/70">
      <div className="mx-auto max-w-[1320px] px-6 py-20 lg:px-10 lg:py-28">
        ...
        <p className="display-xl max-w-[24ch] text-[clamp(1.9rem,5.4vw,4.6rem)] text-ink">
        ...
        <div className="mt-16 grid gap-px border border-line bg-line md:grid-cols-3" data-reveal-stagger="90">
          {principles.map((item) => (
            <div
              key={item.id}
              data-reveal="scale"
        ...
        <div className="mt-14 grid gap-8 md:grid-cols-12">
          <p
            className="reveal text-base leading-relaxed text-dim md:col-span-7"
            data-reveal="left"
          >
